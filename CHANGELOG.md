...
This project follows semantic versioning once public releases begin. Until a
tag and release receipt exist, everything remains under `Unreleased` even
though the package metadata carries the intended first version.
...
No GitHub release or PyPI package has been published.
